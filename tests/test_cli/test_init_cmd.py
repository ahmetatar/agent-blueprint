...
class TestInitCommand:
    def test_spec_template_creates_markdown_by_default(self, tmp_path, monkeypatch):
    ...
    def test_spec_template_output_inflects_blueprint_name(self, tmp_path, monkeypatch):
        monkeypatch.chdir(tmp_path)
    ...
    def test_spec_template_accepts_double_dash_o_alias(self, tmp_path, monkeypatch):
        monkeypatch.chdir(tmp_path)
    ...
    def test_blueprint_template_creates_yaml_by_default(self, tmp_path, monkeypatch):
        monkeypatch.chdir(tmp_path)
    ...
    def test_blueprint_template_output_inflects_blueprint_name(self, tmp_path, monkeypatch):
        monkeypatch.chdir(tmp_path)
